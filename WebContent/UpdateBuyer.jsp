	  ...
	  <fieldset>
	    ...
	    <div class="input-group">
	     ...
	     <div class="input-group">
	      ...
	      <input type="text" class="form-control" id="street1" name="street1" value="${buyer.getStreet1()}" required>
	    </div><br>
	    ...
	    <div class="input-group">
	      ...
	      <input type="text" class="form-control" id="street2" name="street2" value="${buyer.getStreet2()}" required>
	    </div><br>
	    ...
	    <div class="input-group">
	     ...
	     <div class="input-group">
	      ...
	      <input type="text" class="form-control" id="zip" name="zip" value="${buyer.getZip()}" required>
	    </div><br>
